/**
 * BODA-128 · LOS ESTADOS DE LA PANTALLA DE CONTENIDO
 *
...
export type EstadoContenido =
  "mostrada" | "ocultada" | "movida" | "seccion-desconocida" | "sin-permiso" | "error";

/** Cuáles se cuentan como un fallo. Decide el color del aviso y su `role`. */
export const ESTADOS_DE_ERROR: readonly EstadoContenido[] = [
  "seccion-desconocida",
  "sin-permiso",
  "error",
];

export function esEstadoContenido(valor: string): valor is EstadoContenido {
  return (["mostrada", "ocultada", "movida", ...ESTADOS_DE_ERROR] as string[]).includes(valor);
}
